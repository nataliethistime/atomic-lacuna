            ...
            buildPlans: function (types) {
                ...
                for (var n = 0; n < types.length; n++) {
                    ...
                    frag[frag.length] = [
                        ...
                        '        </div>',
                        '        <div class="yui-u">',
                        //'            <input type="radio" name="stationLabSelectType" value="',plan.type,'" style="margin-top:30px;margin-left:30px;" />','            <button type="button" value="', plan.type, '">Select</button>','        </div>',
                        '    </div>',
                        '</li>'
                        ].join('');
                }
            ...
            buildLevels: function (levelCosts) {
                ...
                for (var n = 0; n < levelCosts.length; n++) {
                    ...
                    frag[frag.length] = [
                        ...
                        '    <td>', costs.waste, '</td>',
                        //'    <td><input type="radio" name="stationLabSelectLevel" value="',costs.level,'" /></td>','    <td><button type="button" value="', costs.level, '">Make</button></td>','</tr>'
                        ].join('');
                }
