...
if (typeof YAHOO.lacuna.buildings.TheDillonForge == "undefined" || !YAHOO.lacuna.buildings.TheDillonForge) {
    ...
    (function () {
        ...
        Lang.extend(TheDillonForge, Lacuna.buildings.Building, {
            ...
            viewForgeMakePlan: function () {
                ...
                Event.on(button, "click", this.MakePlan, {
                    Self: this
                }, true);
            },
            MakePlan: function () {
            ...
            viewForgeSplitPlan: function () {
                ...
                Event.on(button, "click", this.SplitPlan, {
                    Self: this
                }, true);
            },
            SplitPlan: function () {
            ...
            viewForgeSubsidize: function () {
                ...
                Event.on(button, "click", this.Subsidize, {
                    Self: this
                }, true);
            },
            Subsidize: function () {
    ...
    YAHOO.register("TheDillonForge", YAHOO.lacuna.buildings.TheDillonForge, {
        version: "1",
        build: "0"
    });
