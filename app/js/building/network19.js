...
if (typeof YAHOO.lacuna.buildings.Network19 == "undefined" || !YAHOO.lacuna.buildings.Network19) {
            ...
            NewsCoverage: function (e) {
                ...
                this.service.restrict_coverage({
                    ...
                    success: function (o) {
                        ...
                        Lacuna.Pulser.Hide();
                        this.rpcSuccess(o);
                        Dom.get("newsCoverageText")
                            .innerHTML = isRestrict ? 'Coverage is currently restricted' : 'News is flowing freely';
    ...
    YAHOO.register("network19", YAHOO.lacuna.buildings.Network19, {
        version: "1",
        build: "0"
    });
}
