...
if (typeof YAHOO.lacuna.CreateEmpire == "undefined" || !YAHOO.lacuna.CreateEmpire) {
    (function () {
        ...
        var CreateEmpire = function (Login) {
            ...
            this.Dialog.cfg.queueProperty("keylisteners", new YAHOO.util.KeyListener("empirePassConfirm", {
                keys: 13
            }, {
                fn: this.handleCreate,
                scope: this,
    ...
    YAHOO.register("createEmpire", YAHOO.lacuna.CreateEmpire, {
        version: "1",
        build: "0"
    });
}
