...
If you have any questions or suggestions, please yell at me via the Github Issue tracker. :gun:
...
`<script>` elements onto the page at runtime ('cause that's ugly).
...
No silly web browser rubbish in the way! :dizzy:
